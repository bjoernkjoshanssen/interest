...
\begin{lemma}\label{annuity.id_mul_geom_sum_formula}
...
\begin{lemma}\label{annuity.id_mul_geom_sum₁}
	\lean{annuity.id_mul_geom_sum₁}
	\leanok
	\uses{sum_Icc_succ_eq_sum_range,annuity.id_mul_geom_sum_formula}
Given $x\in\mathbb R$ with $x \ne 1$ and $n\in \mathbb N$, we have
\[
...
\begin{theorem}
	...
	\lean{eq_CPT_N_of_D}
	\leanok
	\uses{AriMagic.unique_solution_n,annuity.id_mul_geom_sum₁,AriMagic.exists_pos_root_of_limits}
