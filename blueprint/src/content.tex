...
\begin{definition}\label{id_mul_geom_sum}
...
\begin{lemma}\label{id_mul_geom_sum₁}
	\lean{annuity.id_mul_geom_sum₁}
	\leanok
	\uses{sum_Icc_succ_eq_sum_range,id_mul_geom_sum_formula}
Given $x\in\mathbb R$ with $x \ne 1$ and $n\in \mathbb N$, we have
\[
...
\begin{definition}\label{bond_price_sum}
...
\begin{definition}\label{bond_price}
...
\begin{definition}\label{a_formula}
...
\begin{lemma}\label{a_eq_a_formula}
	\lean{annuity.a_eq_a_formula}
	\leanok
	\uses{a_formula, a, sum_pow_interest}
...
\begin{theorem}
	...
	\lean{eq_CPT_N_of_D}
	\leanok
	\uses{D,AriMagic.unique_solution_n,id_mul_geom_sum₁,AriMagic.exists_pos_root_of_limits}
