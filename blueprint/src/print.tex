...
\DeclareMathOperator{\IY}{IY}

\DeclareMathOperator{\PMT}{PMT}
\DeclareMathOperator{\FV}{FV}
\DeclareMathOperator{\PV}{PV}
\DeclareMathOperator{\N}{N}
\DeclareMathOperator{\CPTN}{CPT\_N}
\DeclareMathOperator{\CPTPMT}{CPT\_PMT}
\DeclareMathOperator{\CPTIY}{CPT\_IY}
\DeclareMathOperator{\CPTPV}{CPT\_PV}
\DeclareMathOperator{\CPTFV}{CPT\_FV}

\input{macros/common}
\input{macros/print}

\title{Interest: a Lean library for financial mathematics}
